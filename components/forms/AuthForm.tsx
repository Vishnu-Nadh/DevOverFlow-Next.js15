...
const AuthForm = <T extends FieldValues>({ schema, defaultValues, formType, onSubmit }: AuthFormProps<T>) => {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSumbit)} className="mt-10 space-y-6">
                ...
                <FormItem className="flex flex-col w-full gap-2.5">
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      className="paragraph-regular background-light900_dark300 light-border-2 text-dark300_light700 not-focus min-h-12 rounded-1.5 border"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
